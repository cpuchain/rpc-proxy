...
async function digest(buf, algorithm = "SHA-256") {
  return bytesToHex(new Uint8Array(await webcrypto.subtle.digest(algorithm, buf)));
}
...
export { BasicRequest, BlockRespSchema, ErrorObjectSchema, JsonRpcReqSchema, JsonRpcRespSchema, LastBlocks, PostRequest, Proxy, RateLimiter, WebSocketRequest, __dirname, bytesToHex, concatBytes, configSchema, connectWSRpc, createID, digest, existsAsync, filterGetLogParam, filterGetLogs, filterRequest, filterSet, getConfig, hashOrigin, hexToBytes, initProxy, markError, markNewError, rBytes, rangeSet, refreshBlocks, rewriteTag, sendWS, subscribeSet, swaggerUiDir, textEncoder, traceSet, whitelistedSet };
